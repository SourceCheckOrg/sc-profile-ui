...
export default function Search(props) {
  ...
  return (
    <>
      ...
      <QrCodeModal show={showingPaymentAddr} url={profileAddr} title="Polygon Payment Address" message="You can send MATIC or ERC-20 tokens on Polygon mainnet to:" onCancel={(e) => setShowingPaymentAddr(false)} />
      ...
      <main >
        <div className="rounded-lg flex-1 flex-column items-center max-w-2xl mx-auto mt-24 p-6 overflow-y-auto bg-white" tabIndex="0">
          ...
          <div className={`flex flex-row space-x-3 justify-center items-center ${!twitterHandle ? 'hidden' : ''} bg-gray-50 text-center pt-2`}>
            ...
            <div>
              <a onClick={toggleTwitter} className="cursor-pointer">
          ...
          <div className="flex flex-row space-x-3 justify-center items-center bg-gray-100 text-center p-4">
            <Button onClick={() => setShowingPaymentAddr(true)} color="indigo" label="Pay With Polygon" />
          </div> 
        </div>
      </main>
    </>
